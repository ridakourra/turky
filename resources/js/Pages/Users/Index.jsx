  ...
  return (
    <AdminLayout titleHead="Gestion des Utilisateurs" title="Utilisateurs">
      <div className="space-y-6">
        ...
        {/* Filter Card */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <Filter filters={filters} roles={roles} onChange={handleFilterChange} />
        </div>

        {/* Table Card (or Empty State Card) */}
        {users.data.length > 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="border-t border-gray-200 px-6 py-4">
              <Pagination data={users} filters={filters} onChange={handleFilterChange} />
            </div>
          </div>
        ) : (
