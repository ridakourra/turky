...
export default function SalaryInfoForm({ data, setData, errors }) {
    ...
    return (
        <div className="space-y-6 bg-green-50/30 p-6 rounded-lg border border-green-200">
            ...
            {/* Montant du salaire */}
            <div>
                <label htmlFor="montant_salaire" className="block text-sm font-medium text-[#262626] mb-2">
                        ...
                        {data.type_travail === 'par_produit' && (
                            <p>
                                ...
                                <span className="text-xs">
                                    (Ex: 100 produits × {data.montant_salaire} MAD = {(parseFloat(data.montant_salaire || 0) * 100).toFixed(2)} MAD)
                                </span>
                            </p>
                        )}
                    </div>
