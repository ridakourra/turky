...
export default function Edit({ vehicule, chauffeurs }) {
    ...
    return (
        <AdminLayout>
            <Head title={`Modifier ${vehicule.matricule}`} />
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Select value={data.chauffeur_id?.toString() || ''} onValueChange={(value) => setData('chauffeur_id', value === 'none' ? '' : value)}>
                    ...
                    <div className="flex justify-end space-x-4">
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => router.get(route('vehicules.show', vehicule.id))}
                            disabled={processing}
                        >
                            Annuler
                        </Button>
